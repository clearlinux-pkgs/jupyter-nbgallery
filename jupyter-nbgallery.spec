...
Requires: jupyter-nbgallery-data = %{version}-%{release}
...
%package data
Summary: data components for the jupyter-nbgallery package.
Group: Data

%description data
data components for the jupyter-nbgallery package.
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1635745820
...
cp %{_builddir}/jupyter-nbgallery-2.0.0/jupyter_nbgallery/nbextensions/instrumentation/crypto-js-license.txt %{buildroot}/usr/share/package-licenses/jupyter-nbgallery/1d0d2968b35836cde91ab65b1692d1546ffa4fb3
